...
import { createPayment } from '../../../services/finance/financeService';
...
const AddPaymentModal = ({ open, onClose }: Props) => {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    await createPayment(scope.businessId, {
      ...values,
      ...
      <Dialog as="div" className="relative z-40" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-6 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-3xl border border-gray-100 bg-white p-6 text-left align-middle shadow-xl transition-all">
