...
export const SECTION_REGISTRY: Record<SectionType, SectionRegistryEntry> = {
  ...
  cart: {
    ...
    defaultData: {
      ...
      empty_message: 'Looks like you haven\'t added anything yet.',
    ...
    settings: {
      ...
      empty_title: { type: 'text', label: 'Empty cart heading', placeholder: 'Your cart is empty' },
      empty_message: { type: 'text', label: 'Empty cart message', placeholder: 'Looks like you haven\'t added anything yet.' },
      empty_button_text: { type: 'text', label: 'Empty button text', placeholder: 'Continue shopping' },
      empty_button_link: { type: 'text', label: 'Empty button link', placeholder: '/products' },
      checkout_button_text: { type: 'text', label: 'Checkout button text', placeholder: 'Check out' },
      continue_shopping_text: { type: 'text', label: 'Continue shopping text', placeholder: 'Continue shopping' },
      notes_label: { type: 'text', label: 'Notes label', placeholder: 'Order notes' },
      notes_placeholder: { type: 'text', label: 'Notes placeholder', placeholder: 'Special instructions...' },
      shipping_info_text: { type: 'text', label: 'Shipping info text', placeholder: 'Shipping & taxes calculated at checkout' },
      trust_message: { type: 'text', label: 'Trust message', placeholder: 'Secure checkout guaranteed' },
      show_notes: { type: 'toggle', label: 'Show order notes', defaultValue: false },
      show_shipping_info: { type: 'toggle', label: 'Show shipping info', defaultValue: true },
      show_quantity_controls: { type: 'toggle', label: 'Show quantity controls', defaultValue: true },
      show_remove_buttons: { type: 'toggle', label: 'Show remove buttons', defaultValue: true },
      show_product_vendor: { type: 'toggle', label: 'Show product vendor', defaultValue: false },
      show_variant_details: { type: 'toggle', label: 'Show variant details', defaultValue: true },
      show_product_image: { type: 'toggle', label: 'Show product images', defaultValue: true },
      show_trust_badges: { type: 'toggle', label: 'Show trust badges', defaultValue: false },
      show_estimated_total: { type: 'toggle', label: 'Show estimated total', defaultValue: true },
      show_checkout_button: { type: 'toggle', label: 'Show checkout button', defaultValue: true },
      show_continue_shopping: { type: 'toggle', label: 'Show continue shopping link', defaultValue: true },
      preview_mode: {
        type: 'select',
        label: 'Preview mode',
        options: [
