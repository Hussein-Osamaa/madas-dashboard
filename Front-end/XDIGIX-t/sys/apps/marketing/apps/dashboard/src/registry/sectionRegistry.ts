...
export const SECTION_REGISTRY: Record<SectionType, SectionRegistryEntry> = {
  ...
  checkout: {
    ...
    settings: {
      ...
      contact_title: { type: 'text', label: 'Contact section title', placeholder: 'Contact' },
      shipping_title: { type: 'text', label: 'Shipping section title', placeholder: 'Shipping address' },
      payment_title: { type: 'text', label: 'Payment section title', placeholder: 'Payment method' },
      summary_title: { type: 'text', label: 'Summary section title', placeholder: 'Order summary' },
      checkout_button_text: { type: 'text', label: 'Checkout button text', placeholder: 'Complete order' },
      order_notes_label: { type: 'text', label: 'Notes label', placeholder: 'Order notes' },
      order_notes_placeholder: { type: 'text', label: 'Notes placeholder', placeholder: 'Any special instructions...' },
      secure_badge_text: { type: 'text', label: 'Secure badge text', placeholder: 'Secure checkout' },
      support_text: { type: 'text', label: 'Support/help text', placeholder: 'Need help? Contact us' },
      terms_text: { type: 'text', label: 'Terms & conditions text', placeholder: '' },
      delivery_info_text: { type: 'text', label: 'Delivery info text', placeholder: '' },
      show_email: { type: 'toggle', label: 'Show email field', defaultValue: true },
      show_phone: { type: 'toggle', label: 'Show phone field', defaultValue: true },
      show_company: { type: 'toggle', label: 'Show company field', defaultValue: false },
      show_address2: { type: 'toggle', label: 'Show address line 2', defaultValue: false },
      show_postal_code: { type: 'toggle', label: 'Show postal code', defaultValue: true },
      show_order_notes: { type: 'toggle', label: 'Show order notes', defaultValue: true },
      show_billing_toggle: { type: 'toggle', label: 'Show billing address toggle', defaultValue: false },
      show_payment_icons: { type: 'toggle', label: 'Show payment method icons', defaultValue: true },
      show_trust_badges: { type: 'toggle', label: 'Show trust badges', defaultValue: true },
      show_secure_badge: { type: 'toggle', label: 'Show secure checkout badge', defaultValue: true },
      show_terms_link: { type: 'toggle', label: 'Show terms link', defaultValue: false },
      layout: { type: 'select', label: 'Layout', options: [{ value: 'two-column', label: 'Two column' }, { value: 'one-column', label: 'One column' }], defaultValue: 'two-column' },
      color_scheme: { type: 'select', label: 'Color scheme', options: COLOR_SCHEME_OPTIONS, defaultValue: 'scheme-1' },
      padding_top: PADDING_TOP,
      padding_bottom: PADDING_BOTTOM,
    },
