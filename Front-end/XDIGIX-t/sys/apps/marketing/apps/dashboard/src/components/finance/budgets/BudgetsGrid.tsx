...
const statusLabel = {
  on_track: { text: 'On Track', badge: 'bg-emerald-100 text-emerald-700' },
  warning: { text: 'Approaching Limit', badge: 'bg-amber-100 text-amber-700' },
  exceeded: { text: 'Exceeded', badge: 'bg-rose-100 text-rose-700' }
};
  ...
  <div className="space-y-4">
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-xs text-madas-text/60">Click a budget to view category performance, alerts and transactions.</p>
      </div>
    </div>
    {loading ? (
      <div className="rounded-2xl border border-gray-100 bg-white px-4 py-6 text-center text-sm text-madas-text/60">
        Loading budgets...
      </div>
    ) : budgets.length ? (
        ...
        {budgets.map((budget) => {
          ...
          return (
            <button
              ...
              className="flex flex-col gap-3 rounded-2xl border border-gray-100 bg-white p-5 text-left shadow-sm transition hover:-translate-y-1 hover:border-primary/40 hover:shadow-lg"
            >
              <div className="flex items-center justify-between">
                <div>
      ...
      <div className="rounded-2xl border border-dashed border-gray-200 bg-white px-4 py-6 text-center text-sm text-madas-text/60">
