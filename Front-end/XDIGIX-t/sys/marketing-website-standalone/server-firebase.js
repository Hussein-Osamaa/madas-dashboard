...
app.post('/api/register', async (req, res) => {
  try {
    ...
    if (firebaseReady) {
      ...
      console.log('✅ Business document created:', businessId);
      ...
      console.log('✅ Firebase registration completed successfully');
      ...
      console.log('⚠️  Firebase not available, using mock response');
...
╔══════════════════════════════════════════════════════════════╗
║                                                              ║
║   🔥 MADAS Marketing Website with Firebase                  ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝
...
🔥 Firebase Status: ${firebaseReady ? '✅ Connected' : '❌ Not Connected'}

🔧 API Endpoints:
   → POST /api/register ${firebaseReady ? '(Firebase)' : '(Mock)'}
   → POST /api/contact ${firebaseReady ? '(Firebase)' : '(Mock)'}
   → POST /api/newsletter/subscribe ${firebaseReady ? '(Firebase)' : '(Mock)'}
