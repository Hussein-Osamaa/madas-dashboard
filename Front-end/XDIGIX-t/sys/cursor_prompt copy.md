...
**Key Components:**
- `FeatureDetail.jsx` - Individual feature showcases
- `UseCaseCard.jsx` - Business type examples
- `IntegrationGrid.jsx` - Partner integrations
...
**Key Components:**
- `PricingTable.jsx` - Full comparison table
- `PricingFAQ.jsx` - Billing questions
- `ROICalculator.jsx` - Show potential savings
...
**Key Components:**
- `DocSidebar.jsx` - Documentation navigation
- `DocContent.jsx` - Article content
- `DocSearch.jsx` - Search functionality
...
**Key Components:**
- `BlogList.jsx` - Article grid
- `BlogPost.jsx` - Single article view
- `BlogSidebar.jsx` - Categories and recent posts
...
- `SubscriptionPieChart.jsx` - Plan distribution
...
**Key Components:**
- `ClientsList.jsx` - Main clients table
- `ClientFilters.jsx` - Filter controls
- `ClientDetail.jsx` - Detailed client view
- `SubscriptionManager.jsx` - Subscription controls
- `UsageMetrics.jsx` - Usage visualization
- `ClientActions.jsx` - Admin action buttons
...
**Key Components:**
- `SubscriptionsList.jsx` - All subscriptions
- `SubscriptionDetail.jsx` - Single subscription view
- `BillingHistory.jsx` - Payment history table
- `SubscriptionActions.jsx` - Admin controls
...
**Key Components:**
- `RevenueAnalytics.jsx` - Financial dashboard
- `RevenueChart.jsx` - Revenue visualizations
- `PaymentAnalytics.jsx` - Payment data
- `FinancialReports.jsx` - Report generator
...
**Key Components:**
- `PlatformAnalytics.jsx` - Analytics dashboard
- `UserMetrics.jsx` - User statistics
- `EngagementCharts.jsx` - Usage visualizations
- `ConversionFunnel.jsx` - Conversion tracking
...
**Key Components:**
- `TicketList.jsx` - Support ticket table
- `TicketDetail.jsx` - Ticket conversation view
- `TicketReply.jsx` - Reply form
- `TicketAssignment.jsx` - Team assignment
- `TicketStats.jsx` - Support metrics
...
**Key Components:**
- `NewsletterList.jsx` - Subscriber management
- `ContactSubmissions.jsx` - Contact form leads
- `EmailCampaign.jsx` - Campaign creator
- `CampaignAnalytics.jsx` - Email metrics
...
**Key Components:**
- `PlatformSettings.jsx` - Settings layout
- `PricingConfig.jsx` - Plan configuration
- `EmailTemplates.jsx` - Email management
- `IntegrationSettings.jsx` - API configurations
- `AdminManagement.jsx` - Admin users
- `SystemMaintenance.jsx` - System controls
...
- `ReportScheduler.jsx` - Automated reports
...
**Key Components:**
- `ActivityLogs.jsx` - Event log viewer
- `LogFilters.jsx` - Filter controls
- `LogDetail.jsx` - Event details modal
...
**Key Components:**
- `NotificationCenter.jsx` - Alert inbox
- `NotificationSettings.jsx` - Preferences
...
- `SignupForm.jsx` - Registration with business creation
...
- `SalesOverview.jsx` - Sales cards and stats
- `SalesChart.jsx` - Line/bar chart
- `LowStockAlert.jsx` - Inventory alerts widget
- `RecentOrders.jsx` - Order list widget
...
**Key Components:**
- `ProductList.jsx` - Main product table
- `ProductForm.jsx` - Add/edit form
- `ProductCard.jsx` - Product display card
- `BulkImport.jsx` - CSV import interface
- `InventoryAdjustment.jsx` - Stock adjustment modal
...
**Key Components:**
- `POSInterface.jsx` - Main POS screen
- `ProductGrid.jsx` - Product selection
- `POSCart.jsx` - Cart display
- `PaymentModal.jsx` - Payment processing
- `ReceiptPrint.jsx` - Receipt template
...
- `OrderTimeline.jsx` - Order history timeline
...
- `SubscriptionManagement.jsx`# CURSOR AI PROMPT - MULTI-TENANT BUSINESS MANAGEMENT SAAS
...
These are already defined at the beginning of the document (lines 23-362) using JavaScript syntax. Refer to those for the complete schemas.
...
Based on the scan of your existing HTML pages, here are 12 additional advanced features to implement:

### 14. GAMIFICATION HUB 🎮
Central hub for gamification features to boost customer engagement.

**Features:**
- Spin the wheel (discount wheel)
- Scratch cards  
- MADAS Pass (membership system)
- Loyalty program integration
- Game statistics dashboard
- Customer participation tracking

**Key Components:**
- `GameHub.jsx` - Main gamification dashboard
- `DiscountWheel.jsx` - Spin to win interface
- `ScratchCard.jsx` - Digital scratch cards
- `MADASPass.jsx` - Membership pass display
- `GameStats.jsx` - Gamification analytics
- `GameCustomizer.jsx` - Customize game appearance

### 15. LOYALTY PROGRAM 💎
Advanced customer loyalty with multiple tiers.
...
### 16. MADAS PASS (MEMBERSHIP SYSTEM) 🎫
Digital membership pass with QR codes.

**Features:**
- Digital wallet pass (Apple/Google Wallet)
- QR code generation for scanning
- Membership benefits
- Pass customization (colors, logo)
- Expiration tracking
- Auto-renewal
- Scan history

**Key Components:**
- `MADASPassGenerator.jsx`
- `PassDesigner.jsx`
- `PassScanner.jsx`
...
**Key Components:**
- `CollectionsList.jsx`
- `CollectionBuilder.jsx`
- `CollectionDisplay.jsx`
- `CollectionRules.jsx`

### 19. ADVANCED INSIGHTS 📊
Business intelligence beyond basic analytics.
...
Shareholder and equity management.
...
**Key Components:**
- `ShareholdersList.jsx`
- `ShareDistribution.jsx`
- `DividendCalculator.jsx`
- `ShareTransfer.jsx`

### 21. SCAN LOG 📱
QR code and barcode scanning history.
...
### 22. CUSTOM DOMAINS 🌐
Multi-domain management for businesses.
...
- `DomainsList.jsx`
- `DomainSetup.jsx`
- `DNSConfiguration.jsx`
- `SSLManager.jsx`

### 23. LOW STOCK ALERTS 🔔
Advanced inventory alerts and automation.
...
- `LowStockAlerts.jsx`
- `ReorderManager.jsx`
- `StockForecasting.jsx`
- `AutoPurchaseOrder.jsx`

### 24. CUSTOMER WALLET 💰
Customer wallet and prepaid balance system.
...
1. Use JSDoc comments for documentation
2. Use PropTypes for component props validation (optional)
3. Use const/let instead of var
4. Use proper null/undefined checks
...
**Check Limits:**
```javascript
const canAddProduct = async (businessId) => {
...
**Feature Gates:**
```javascript
const canAccessWebsiteBuilder = (plan) => {
...
const startTrial = async (userId, plan) => {
...
const createStripeCustomer = async (userId, paymentMethod) => {
...
**5. Upgrade/Downgrade:**
```javascript
const changeSubscription = async (subscriptionId, newPriceId) => {
...
// Churn Rate
const calculateChurnRate = async (month) => {
...
// Customer Lifetime Value
const calculateLTV = (avgMonthlyValue, avgLifespanMonths) => {
  return avgMonthlyValue * avgLifespanMonths;
};

// Customer Acquisition Cost
const calculateCAC = (marketingSpend, newCustomers) => {
...
**Marketing Website:**
```bash
npm create vite@latest marketing-website -- --template react
...
**vite.config.js** (for all three projects):
```javascript
...
**router.jsx** example (for client app):
```javascript
...
cd admin-dashboard
npm run dev # Change port to 3001 in vite.config.js

# Terminal 3 - Client App
cd client-app
npm run dev # Change port to 3002 in vite.config.js
```
...
**1. Create Your First App (Marketing Website):**
```bash
# Create project with JavaScript template
npm create vite@latest marketing-website -- --template react
...
npm install react-router-dom firebase zustand
...
### 1. **Use JSDoc for Type Safety (Optional but Recommended):**
...
### 2. **Use PropTypes for React Components:**
...
### 3. **Modern JavaScript Features to Use:**

```javascript
// Destructuring
const { businessId, products } = businessData;
...
// Template literals
const greeting = `Hello, ${user.name}! You have ${orderCount} orders.`;
```
...
async function saveProduct(productData) {
  try {
    const result = await addDoc(collection(db, 'products'), productData);
...
## 🐛 COMMON JAVASCRIPT GOTCHAS TO AVOID
...
### 4. **Async Function Return Values:**
```javascript
// ❌ BAD - Returns Promise, not the value
const user = getCurrentUser(); // Promise<User>
...
3. ✅ **Initialize your first app** using the commands above
4. ✅ **Copy code examples** from this guide (all are JavaScript-ready!)
5. ✅ **Start with Marketing Website** (easier, no authentication needed)
6. ✅ **Build authentication** (Firebase Auth is simple in JavaScript)
7. ✅ **Create your first feature** (Products management is a good start)
8. ✅ **Deploy to Vercel** (one command: `vercel`)

### Resources:

- **Firebase JavaScript Docs**: https://firebase.google.com/docs/web/setup
...
🚀 **JavaScript is faster to develop** - No type checking delays
💪 **JavaScript is powerful** - All the same features as TypeScript
🎯 **JavaScript is practical** - Perfect for MVPs and rapid prototyping
⚡ **JavaScript is battle-tested** - Used by millions of production apps

**Good luck building your SaaS platform! 🚀 You've got this! 💪**