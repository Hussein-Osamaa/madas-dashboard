...
.xd-card-minimal .xd-product-btn{border:none;background:none;padding:0;text-decoration:underline;text-transform:none;letter-spacing:normal;font-weight:600;border-radius:0}
